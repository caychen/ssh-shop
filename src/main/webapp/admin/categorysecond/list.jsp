						...
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<s:iterator var="cs" value="pageBean.data" status="status">
					...
					<tr align="center">
						<td colspan="4">
							...
							<s:if test="pageBean.pageNo != 1">
								...
								<a href="${pageContext.request.contextPath }/adminCategorySecond_findAll.action?page=<s:property value="pageBean.pageNo-1"/>">上一页</a> |
							</s:if>
							<s:if test="pageBean.pageNo != pageBean.totalPage">
								<a href="${pageContext.request.contextPath }/adminCategorySecond_findAll.action?page=<s:property value="pageBean.pageNo+1"/>">下一页</a> |
