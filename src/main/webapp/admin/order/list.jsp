		...
		<script type="text/javascript">
			function showDetail(oid){
				...
				if(but.value == "订单详情"){
					...
					// 3.打开连接
					xhr.open("GET","${pageContext.request.contextPath}/adminOrder_findOrderItem.action?oid="+oid+"&_="+new Date().getTime(),true);
					// 4.发送
					xhr.send(null);
					but.value = "关闭";
				}else{
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/user/list.jsp" method="post">
			<table cellSpacing="1" cellPadding="0" width="100%" align="center" bgColor="#f5fafe" border="0">
				<TBODY>
						...
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<s:iterator var="o" value="pageBean.data" status="status">
					...
					<tr align="center">
						<td colspan="7">
							第<s:property value="pageBean.pageNo"/>/<s:property value="pageBean.totalPage"/>页 
							<s:if test="pageBean.pageNo != 1">
								<a href="${ pageContext.request.contextPath }/adminOrder_findAll.action?page=1">首页</a>|
								<a href="${ pageContext.request.contextPath }/adminOrder_findAll.action?page=<s:property value="pageBean.pageNo-1"/>">上一页</a>|
							</s:if>
							<s:if test="pageBean.pageNo != pageBean.totalPage">
								<a href="${ pageContext.request.contextPath }/adminOrder_findAll.action?page=<s:property value="pageBean.pageNo+1"/>">下一页</a>|
