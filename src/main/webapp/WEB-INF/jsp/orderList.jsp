...
<div class="container cart">
		...
		<div class="span24">
			...
			<div class="step step1">
				...
				<table>
					<tbody>
					<s:iterator value="pageBean.data" var="order">
					<tr>
						<th colspan="5">
						...
						<s:iterator value="#order.orderItems" var="orderItem">
							<tr>
								...
								<td width="140">
									<span class="subtotal">￥<s:property value="#orderItem.subMoney"/></span>
								</td>
							</tr>
						</s:iterator>
					</s:iterator>
						...
						<div class="pagination">
							<span>第<s:property value="pageBean.pageNo"/>/<s:property value="pageBean.totalPage"/>页</span>
								<s:if test="pageBean.pageNo != 1">
									<a href="${pageContext.request.contextPath }/order_findByUid.action" class="firstPage">&nbsp;</a>
									<a href="${pageContext.request.contextPath }/order_findByUid.action?pageNo=<s:property value="pageBean.pageNo - 1"/>" class="previousPage">&nbsp;</a>
								</s:if>
								<s:iterator begin="1" end="pageBean.totalPage" var="i">
									<s:if test="pageBean.pageNo != #i">
										<a href="${pageContext.request.contextPath }/order_findByUid.action?pageNo=<s:property value="#i"/>"><s:property value="#i"/></a>
									</s:if>
									<s:else>
								...
								<s:if test="pageBean.pageNo != pageBean.totalPage">
									<a class="nextPage" href="${pageContext.request.contextPath }/order_findByUid.action?pageNo=<s:property value="pageBean.pageNo + 1"/>">&nbsp;</a>
									<a class="lastPage" href="${pageContext.request.contextPath }/order_findByUid.action?pageNo=<s:property value="pageBean.totalPage"/>">&nbsp;</a>
								</s:if>
						</div>
						</td>
					</tr>
